...
mod tests {
    ...
    fn word_lists() {
        for [words, expected] in [
            [
                include_str!("tests/bip_39.txt"),
                "0D021C91D40FD1D87C3ECECB3DEECA30EA3768F87A6618EDD5E6878F4727D7B2",
            ],
            [
                include_str!("tests/eff_large_wordlist.txt"),
                "339BEABED2F5700BEFF323A75680E5A16D0DA176816665355A67817A73302782",
            ],
            [
                include_str!("tests/eff_short_wordlist_1.txt"),
                "70907533251C0E2B66552827B29A5C4F381F4301C961C194B066C21B005A5A73",
            ],
            [
                include_str!("tests/eff_short_wordlist_2.txt"),
                "618BD4C217340D8EF106048CF3341DDD6C366695F6A914233F22EF16E8E84DD3",
            ],
            [
                include_str!("tests/wordle_words5_big.txt"),
                "F6ED9C0621C12669791A97B71BAB582B05951F7B2827AAB31A6212381E13D769",
            ],
            [
                include_str!("tests/wordle_words5.txt"),
                "11013813008811902644706A2874A0E155BE2ACC17FA6FA953C9406450DF870F",
            ],
        ] {
